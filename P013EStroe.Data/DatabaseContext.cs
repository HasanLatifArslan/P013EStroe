...
namespace P013EStroe.Data
{
	public class DatabaseContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<AppUser>().Property(a=>a.Name).IsRequired().HasMaxLength(50); // fluentapi ile appuser classının name propertysi için oluşacak veritabanı kolonu ayarlarını bu şekilde belirleyebilirz
			modelBuilder.Entity<AppUser>().Property(a => a.Surname).HasMaxLength(50);
			modelBuilder.Entity<AppUser>().Property(a => a.UserName).HasMaxLength(50);
